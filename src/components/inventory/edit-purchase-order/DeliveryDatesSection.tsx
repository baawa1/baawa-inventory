...
export function DeliveryDatesSection({ form }: DeliveryDatesSectionProps) {
  const actualDeliveryValue = form.watch("actualDeliveryDate");
  console.log(
    "DeliveryDatesSection - Actual Delivery Value:",
    actualDeliveryValue
  );
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <FormField
          ...
          render={({ field }) => {
            console.log("Actual Delivery Field Value:", field.value);
            return (
              <FormItem className="flex flex-col">
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea
                {...field}
                placeholder="Enter any additional notes about this purchase order..."
