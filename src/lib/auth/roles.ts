...
export const ROLE_PERMISSIONS = {
  ...
  PURCHASE_ORDER_READ: [USER_ROLES.ADMIN, USER_ROLES.MANAGER, USER_ROLES.STAFF],
  PURCHASE_ORDER_WRITE: [USER_ROLES.ADMIN, USER_ROLES.MANAGER],
  PURCHASE_ORDER_APPROVE: [USER_ROLES.ADMIN, USER_ROLES.MANAGER],
  PURCHASE_ORDER_DELETE: [USER_ROLES.ADMIN],
  PURCHASE_ORDER_RECEIVE: [USER_ROLES.ADMIN, USER_ROLES.MANAGER],
};
