...
export const MANUAL_ALLOWED_INCOME_SOURCE_VALUES = [
  INCOME_SOURCES.SERVICES,
  INCOME_SOURCES.INVESTMENTS,
  INCOME_SOURCES.ROYALTIES,
  INCOME_SOURCES.COMMISSIONS,
  INCOME_SOURCES.OTHER,
] as const;

export const MANUAL_ALLOWED_EXPENSE_TYPE_VALUES = [
  EXPENSE_TYPES.UTILITIES,
  EXPENSE_TYPES.RENT,
  EXPENSE_TYPES.SALARIES,
  EXPENSE_TYPES.MARKETING,
  EXPENSE_TYPES.OFFICE_SUPPLIES,
  EXPENSE_TYPES.TRAVEL,
  EXPENSE_TYPES.INSURANCE,
  EXPENSE_TYPES.MAINTENANCE,
  EXPENSE_TYPES.OTHER,
] as const;
