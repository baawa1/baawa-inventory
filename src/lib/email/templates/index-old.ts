...
function _getUserSuspendedTemplate(data: {
  ...
  const content = `
    <h1 class="title">Account Suspended ⚠️</h1>
    <div class="content">
        <p>Hi ${data.firstName},</p>
        ...
        <p>Please contact ${data.adminName} to discuss this matter further.</p>
        <p>Best regards,<br>The Baawa Team</p>
    </div>
  `;
...
function _getUserReactivatedTemplate(data: {
  ...
  const content = `
    ...
    <div class="content">
        <p>Hi ${data.firstName},</p>
        <p>Your account has been reactivated by ${data.adminName}.</p>
