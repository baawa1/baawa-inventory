...
| POS analytics | `/pos/analytics`, `/pos/analytics/categories`, `/pos/analytics/products` | `/api/pos/analytics/overview`, `/api/pos/analytics/categories`, `/api/pos/analytics/products`, `/api/pos/analytics/products/export`, `/api/pos/analytics/customers`, `/api/pos/analytics/customers/:email/orders` | Date ranges, export behavior | Unit, Integration, E2E | Not Started |
...
| Analytics dashboards | `/finance/reports/analytics`, `/finance/reports/cash-flow`, `/finance/reports/expenses` (redirect), `/finance/reports/income-statement`, `/finance/reports/overlap-audit` | `/api/finance/analytics`, `/api/finance/receivables`, `/api/finance/cash-flow-forecast`, `/api/finance/overlap-audit`, `/api/finance/reports/history` | Shared aggregation consistency, admin-only access, overlap exclusion, snapshot history, date ranges | Unit, Integration, E2E | In Progress |
