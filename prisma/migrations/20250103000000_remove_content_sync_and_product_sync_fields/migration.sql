...
-- DropIndex
DROP INDEX "idx_content_sync_entity_id";

-- DropIndex
DROP INDEX "idx_content_sync_entity_type";

-- DropIndex
DROP INDEX "idx_content_sync_sync_status";

-- DropIndex
DROP INDEX "unique_entity_content_sync";
...
-- AlterTable
ALTER TABLE "products" DROP COLUMN "last_sync_at",
